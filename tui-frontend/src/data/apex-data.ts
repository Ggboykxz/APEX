...
export const APEX_MODELS: ApexModel[] = [
  { id: "claude-4-sonnet", name: "Claude 4 Sonnet", provider: "Anthropic", description: "Latest Claude model", contextWindow: 200000, maxTokens: 16384, supportsVision: true, supportsTools: true, inputCostPer1K: 0.003, outputCostPer1K: 0.015 },
  { id: "claude-4-opus", name: "Claude 4 Opus", provider: "Anthropic", description: "Most powerful Claude", contextWindow: 200000, maxTokens: 32768, supportsVision: true, supportsTools: true, inputCostPer1K: 0.015, outputCostPer1K: 0.075 },
  { id: "claude-3.7-sonnet", name: "Claude 3.7 Sonnet", provider: "Anthropic", description: "Enhanced Sonnet", contextWindow: 200000, maxTokens: 8192, supportsVision: true, supportsTools: true, inputCostPer1K: 0.003, outputCostPer1K: 0.015 },
  { id: "claude-3.5-sonnet", name: "Claude 3.5 Sonnet", provider: "Anthropic", description: "Fast and capable", contextWindow: 200000, maxTokens: 8192, supportsVision: true, supportsTools: true, inputCostPer1K: 0.003, outputCostPer1K: 0.015 },
  { id: "claude-3.5-haiku", name: "Claude 3.5 Haiku", provider: "Anthropic", description: "Fastest Claude", contextWindow: 200000, maxTokens: 8192, supportsVision: true, supportsTools: true, inputCostPer1K: 0.0008, outputCostPer1K: 0.004 },
  { id: "gpt-4o", name: "GPT-4o", provider: "OpenAI", description: "Most capable OpenAI model", contextWindow: 128000, maxTokens: 16384, supportsVision: true, supportsTools: true, inputCostPer1K: 0.0025, outputCostPer1K: 0.01 },
  { id: "gpt-4o-mini", name: "GPT-4o Mini", provider: "OpenAI", description: "Fast and affordable", contextWindow: 128000, maxTokens: 16384, supportsVision: true, supportsTools: true, inputCostPer1K: 0.00015, outputCostPer1K: 0.0006 },
  { id: "gpt-4-turbo", name: "GPT-4 Turbo", provider: "OpenAI", description: "Previous gen flagship", contextWindow: 128000, maxTokens: 4096, supportsVision: true, supportsTools: true, inputCostPer1K: 0.01, outputCostPer1K: 0.03 },
  { id: "o3", name: "o3", provider: "OpenAI", description: "Advanced reasoning", contextWindow: 200000, maxTokens: 100000, supportsVision: true, supportsTools: true, inputCostPer1K: 0.01, outputCostPer1K: 0.04 },
  { id: "o1", name: "o1", provider: "OpenAI", description: "Reasoning model", contextWindow: 200000, maxTokens: 100000, supportsVision: true, supportsTools: false, inputCostPer1K: 0.015, outputCostPer1K: 0.06 },
  { id: "o1-mini", name: "o1 Mini", provider: "OpenAI", description: "Fast reasoning", contextWindow: 128000, maxTokens: 65536, supportsVision: false, supportsTools: false, inputCostPer1K: 0.0011, outputCostPer1K: 0.0044 },
  { id: "gemini-2.5-pro", name: "Gemini 2.5 Pro", provider: "Google", description: "Most capable Gemini", contextWindow: 1000000, maxTokens: 65536, supportsVision: true, supportsTools: true, inputCostPer1K: 0.00125, outputCostPer1K: 0.005 },
  { id: "gemini-2.5-flash", name: "Gemini 2.5 Flash", provider: "Google", description: "Fast Gemini", contextWindow: 1000000, maxTokens: 65536, supportsVision: true, supportsTools: true, inputCostPer1K: 0.000075, outputCostPer1K: 0.0003 },
  ...
  { id: "mistral-large", name: "Mistral Large", provider: "Mistral", description: "Flagship Mistral", contextWindow: 128000, maxTokens: 8192, supportsVision: false, supportsTools: true, inputCostPer1K: 0.002, outputCostPer1K: 0.006 },
  { id: "mistral-medium", name: "Mistral Medium", provider: "Mistral", description: "Balanced model", contextWindow: 32000, maxTokens: 8192, supportsVision: false, supportsTools: true, inputCostPer1K: 0.00045, outputCostPer1K: 0.0015 },
  { id: "codestral", name: "Codestral", provider: "Mistral", description: "Code specialist", contextWindow: 256000, maxTokens: 8192, supportsVision: false, supportsTools: true, inputCostPer1K: 0.00045, outputCostPer1K: 0.0015 },
  { id: "deepseek-v3", name: "DeepSeek V3", provider: "DeepSeek", description: "Open MoE model", contextWindow: 128000, maxTokens: 8192, supportsVision: false, supportsTools: true, inputCostPer1K: 0.00027, outputCostPer1K: 0.00107 },
  { id: "deepseek-r1", name: "DeepSeek R1", provider: "DeepSeek", description: "Reasoning model", contextWindow: 128000, maxTokens: 16384, supportsVision: false, supportsTools: true, inputCostPer1K: 0.00055, outputCostPer1K: 0.00219 },
  ...
  { id: "command-r-plus", name: "Command R+", provider: "Cohere", description: "Enterprise RAG", contextWindow: 128000, maxTokens: 4096, supportsVision: false, supportsTools: true, inputCostPer1K: 0.0005, outputCostPer1K: 0.002 },
  { id: "command-r", name: "Command R", provider: "Cohere", description: "Efficient RAG", contextWindow: 128000, maxTokens: 4096, supportsVision: false, supportsTools: true, inputCostPer1K: 0.00025, outputCostPer1K: 0.001 },
  { id: "phi-4", name: "Phi-4", provider: "Microsoft", description: "Small but mighty", contextWindow: 16384, maxTokens: 4096, supportsVision: true, supportsTools: true, inputCostPer1K: 0.0003, outputCostPer1K: 0.0006 },
  { id: "phi-4-mini", name: "Phi-4 Mini", provider: "Microsoft", description: "Tiny but capable", contextWindow: 128000, maxTokens: 4096, supportsVision: false, supportsTools: true, inputCostPer1K: 0.0002, outputCostPer1K: 0.0004 },
]
