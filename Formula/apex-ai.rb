class ApexAi < Formula
  ...
  url "https://github.com/Ggboykxz/APEX/archive/refs/tags/v1.2.0.tar.gz"
  # SHA256 calculated from v1.2.0 release tarball
  ...
  resource "apex-ai" do
    url "https://pypi.org/packages/source/a/apex-ai/apex-ai-1.2.0.tar.gz"
  ...
  test do
    assert_match "1.2.0", shell_output("#{bin}/apex --version 2>&1", 0)
  end
end
