...
MODELS: dict[str, str] = {
    ...
    # ── OpenCode Zen (free + pay-as-you-go curated models) ──
    "zen-minimax-m2.5-free": "opencode/minimax-m2.5-free",
    "zen-qwen3.6-plus-free": "opencode/qwen3.6-plus-free",
    "zen-nemotron-3-super-free": "opencode/nemotron-3-super-free",
    "zen-claude-sonnet-4.6": "opencode/claude-sonnet-4-6",
    "zen-claude-opus-4.6": "opencode/claude-opus-4-6",
    "zen-gpt-5": "opencode/gpt-5",
    "zen-gpt-5.4": "opencode/gpt-5.4",
    "zen-gemini-3-flash": "opencode/gemini-3-flash",
    "zen-gemini-3.1-pro": "opencode/gemini-3.1-pro",
    "zen-kimi-k2.5": "opencode/kimi-k2.5",
    "zen-kimi-k2.6": "opencode/kimi-k2.6",
    "zen-glm-5": "opencode/glm-5",
    "zen-glm-5.1": "opencode/glm-5.1",
    "zen-minimax-m2.5": "opencode/minimax-m2.5",
    "zen-minimax-m2.7": "opencode/minimax-m2.7",
    "zen-deepseek-v4-pro": "opencode/deepseek-v4-pro",
    "zen-deepseek-v4-flash": "opencode/deepseek-v4-flash",
    "zen-qwen3.5-plus": "opencode/qwen3.5-plus",
    "zen-qwen3.6-plus": "opencode/qwen3.6-plus",
    "zen-grok-code-fast": "opencode/grok-code-fast-1",
    # ── OpenCode Go ($10/mo subscription, curated open models) ──
    "go-glm-5": "opencode-go/glm-5",
    "go-glm-5.1": "opencode-go/glm-5.1",
    "go-kimi-k2.5": "opencode-go/kimi-k2.5",
    "go-kimi-k2.6": "opencode-go/kimi-k2.6",
    "go-minimax-m2.5": "opencode-go/minimax-m2.5",
    "go-minimax-m2.7": "opencode-go/minimax-m2.7",
    "go-qwen3.5-plus": "opencode-go/qwen3.5-plus",
    "go-qwen3.6-plus": "opencode-go/qwen3.6-plus",
    "go-deepseek-v4-pro": "opencode-go/deepseek-v4-pro",
    "go-deepseek-v4-flash": "opencode-go/deepseek-v4-flash",
}

MODEL_PROVIDERS: dict[str, str | None] = {
    # ── OpenCode Zen (free + pay-as-you-go, needs OPENCODE_API_KEY) ──
    "zen-minimax-m2.5-free": "OPENCODE_API_KEY",
    "zen-qwen3.6-plus-free": "OPENCODE_API_KEY",
    "zen-nemotron-3-super-free": "OPENCODE_API_KEY",
    "zen-claude-sonnet-4.6": "OPENCODE_API_KEY",
    "zen-claude-opus-4.6": "OPENCODE_API_KEY",
    "zen-gpt-5": "OPENCODE_API_KEY",
    "zen-gpt-5.4": "OPENCODE_API_KEY",
    "zen-gemini-3-flash": "OPENCODE_API_KEY",
    "zen-gemini-3.1-pro": "OPENCODE_API_KEY",
    "zen-kimi-k2.5": "OPENCODE_API_KEY",
    "zen-kimi-k2.6": "OPENCODE_API_KEY",
    "zen-glm-5": "OPENCODE_API_KEY",
    "zen-glm-5.1": "OPENCODE_API_KEY",
    "zen-minimax-m2.5": "OPENCODE_API_KEY",
    "zen-minimax-m2.7": "OPENCODE_API_KEY",
    "zen-deepseek-v4-pro": "OPENCODE_API_KEY",
    "zen-deepseek-v4-flash": "OPENCODE_API_KEY",
    "zen-qwen3.5-plus": "OPENCODE_API_KEY",
    "zen-qwen3.6-plus": "OPENCODE_API_KEY",
    "zen-grok-code-fast": "OPENCODE_API_KEY",
    # ── OpenCode Go ($10/mo subscription) ──
    "go-glm-5": "OPENCODE_GO_API_KEY",
    "go-glm-5.1": "OPENCODE_GO_API_KEY",
    "go-kimi-k2.5": "OPENCODE_GO_API_KEY",
    "go-kimi-k2.6": "OPENCODE_GO_API_KEY",
    "go-minimax-m2.5": "OPENCODE_GO_API_KEY",
    "go-minimax-m2.7": "OPENCODE_GO_API_KEY",
    "go-qwen3.5-plus": "OPENCODE_GO_API_KEY",
    "go-qwen3.6-plus": "OPENCODE_GO_API_KEY",
    "go-deepseek-v4-pro": "OPENCODE_GO_API_KEY",
    "go-deepseek-v4-flash": "OPENCODE_GO_API_KEY",
    # ── Anthropic Claude (2024-2026) ──
