...
MODELS: dict[str, str] = {
    ...
    # ── APEX Free (free curated models — powered by OpenCode Zen) ──
    "free-minimax-m2.5": "opencode/minimax-m2.5-free",
    "free-qwen3.6-plus": "opencode/qwen3.6-plus-free",
    "free-nemotron-3-super": "opencode/nemotron-3-super-free",
    "free-grok-code-fast": "opencode/grok-code-fast-1",
    "free-claude-sonnet-4.6": "opencode/claude-sonnet-4-6",
    "free-claude-opus-4.6": "opencode/claude-opus-4-6",
    "free-gpt-5": "opencode/gpt-5",
    "free-gemini-3-flash": "opencode/gemini-3-flash",
    "free-kimi-k2.5": "opencode/kimi-k2.5",
    "free-glm-5": "opencode/glm-5",
    "free-minimax-m2.7": "opencode/minimax-m2.7",
    "free-deepseek-v4-pro": "opencode/deepseek-v4-pro",
    "free-deepseek-v4-flash": "opencode/deepseek-v4-flash",
    "free-qwen3.5-plus": "opencode/qwen3.5-plus",
    "free-qwen3.6-plus": "opencode/qwen3.6-plus",
    # ── APEX Pro ($10/mo subscription, curated open models — powered by OpenCode Go) ──
    "pro-glm-5": "opencode-go/glm-5",
    "pro-glm-5.1": "opencode-go/glm-5.1",
    "pro-kimi-k2.5": "opencode-go/kimi-k2.5",
    "pro-kimi-k2.6": "opencode-go/kimi-k2.6",
    "pro-minimax-m2.5": "opencode-go/minimax-m2.5",
    "pro-minimax-m2.7": "opencode-go/minimax-m2.7",
    "pro-qwen3.5-plus": "opencode-go/qwen3.5-plus",
    "pro-qwen3.6-plus": "opencode-go/qwen3.6-plus",
    "pro-deepseek-v4-pro": "opencode-go/deepseek-v4-pro",
    "pro-deepseek-v4-flash": "opencode-go/deepseek-v4-flash",
}

MODEL_PROVIDERS: dict[str, str | None] = {
    # ── APEX Free (powered by OpenCode Zen, needs OPENCODE_API_KEY) ──
    "free-minimax-m2.5": "OPENCODE_API_KEY",
    "free-qwen3.6-plus": "OPENCODE_API_KEY",
    "free-nemotron-3-super": "OPENCODE_API_KEY",
    "free-grok-code-fast": "OPENCODE_API_KEY",
    "free-claude-sonnet-4.6": "OPENCODE_API_KEY",
    "free-claude-opus-4.6": "OPENCODE_API_KEY",
    "free-gpt-5": "OPENCODE_API_KEY",
    "free-gemini-3-flash": "OPENCODE_API_KEY",
    "free-kimi-k2.5": "OPENCODE_API_KEY",
    "free-glm-5": "OPENCODE_API_KEY",
    "free-minimax-m2.7": "OPENCODE_API_KEY",
    "free-deepseek-v4-pro": "OPENCODE_API_KEY",
    "free-deepseek-v4-flash": "OPENCODE_API_KEY",
    "free-qwen3.5-plus": "OPENCODE_API_KEY",
    "free-qwen3.6-plus": "OPENCODE_API_KEY",
    # ── APEX Pro ($10/mo subscription, powered by OpenCode Go) ──
    "pro-glm-5": "OPENCODE_GO_API_KEY",
    "pro-glm-5.1": "OPENCODE_GO_API_KEY",
    "pro-kimi-k2.5": "OPENCODE_GO_API_KEY",
    "pro-kimi-k2.6": "OPENCODE_GO_API_KEY",
    "pro-minimax-m2.5": "OPENCODE_GO_API_KEY",
    "pro-minimax-m2.7": "OPENCODE_GO_API_KEY",
    "pro-qwen3.5-plus": "OPENCODE_GO_API_KEY",
    "pro-qwen3.6-plus": "OPENCODE_GO_API_KEY",
    "pro-deepseek-v4-pro": "OPENCODE_GO_API_KEY",
    "pro-deepseek-v4-flash": "OPENCODE_GO_API_KEY",
    # ── Anthropic Claude (2024-2026) ──
