...
| Alias | Model String | API Key |
|-------|-------------|---------|
| `ollama-llama3` | `ollama/llama3` | None (local) |
| `ollama-llama3.1` | `ollama/llama3.1` | None (local) |
| `ollama-llama3.2` | `ollama/llama3.2` | None (local) |
| `ollama-llama3.3` | `ollama/llama3.3` | None (local) |
| `ollama-codellama` | `ollama/codellama` | None (local) |
| `ollama-deepseek-coder` | `ollama/deepseek-coder` | None (local) |
| `ollama-deepseek-r1` | `ollama/deepseek-r1` | None (local) |
| `ollama-qwen2.5` | `ollama/qwen2.5` | None (local) |
| `ollama-qwen2.5-coder` | `ollama/qwen2.5-coder` | None (local) |
| `ollama-mistral` | `ollama/mistral` | None (local) |
| `ollama-gemma2` | `ollama/gemma2` | None (local) |
| `ollama-phi3` | `ollama/phi3` | None (local) |
| `ollama-phi4` | `ollama/phi4` | None (local) |
