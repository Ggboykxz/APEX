...
function DocOpenCode() {
  return (
    <div>
      ...
      <p className="text-muted-foreground text-lg mb-8 leading-relaxed">APEX v1.5.0 features the OpenCode architecture — structured messages, snapshots, custom commands, CLI subcommands, and a typed event bus.</p>
