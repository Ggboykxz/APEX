...
function DocOpenCode() {
  return (
    <div>
      ...
      <p className="text-muted-foreground text-lg mb-8 leading-relaxed">APEX v1.2.0 features the OpenCode architecture — structured messages, snapshots, custom commands, and a typed event bus.</p>
