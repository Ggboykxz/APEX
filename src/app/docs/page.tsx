...
function DocOpenCode() {
  return (
    <div>
      ...
      <p className="text-muted-foreground text-lg mb-8 leading-relaxed">APEX v2.0.0 features a modular architecture — structured messages, snapshots, custom commands, CLI subcommands, APEX Gateway proxy, and a typed event bus.</p>
