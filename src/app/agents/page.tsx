      ...
      <main className="flex-1 pt-16">
        ...
        <section className="py-12 bg-card/30">
          <div className="max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <p className="text-muted-foreground mb-6">APEX v1.0.0 features the OpenCode architecture — structured messages, snapshots, custom commands, CLI subcommands, and a typed event bus that powers the agent system.</p>
